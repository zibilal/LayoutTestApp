...
public class OrderDao extends AbstractDao<Order, Long> {
    ...
    */
    ...
    private Query<Order> client_OrdersQuery;
    ...
    /** Internal query to resolve the "orders" to-many relationship of Client. */
    public List<Order> _queryClient_Orders(long customerId) {
        synchronized (this) {
            if (client_OrdersQuery == null) {
                QueryBuilder<Order> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.CustomerId.eq(null));
                queryBuilder.orderRaw("T.'DATE' ASC");
                client_OrdersQuery = queryBuilder.build();
            }
        }
        Query<Order> query = client_OrdersQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN CLIENT T0 ON T.\"CUSTOMER_ID\"=T0.\"_id\"");
            builder.append(' ');
